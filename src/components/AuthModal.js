      ...
      <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 w-full max-w-md border border-white/20">
        ...
        <div className="mt-6">
          ...
          <button
            ...
            disabled={loading}
            className="w-full mt-4 bg-white/10 border border-white/20 text-white py-3 rounded-lg font-semibold hover:bg-white/20 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3"
          >
        ...
        <div className="mt-6 text-center">
          <p className="text-white/60">
            ...
            <button
              onClick={switchMode}
              className="text-purple-400 hover:text-purple-300 ml-1 font-semibold transition-colors"
            >
